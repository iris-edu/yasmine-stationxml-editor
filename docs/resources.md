...
- [NRL webservice](https://service.iris.edu/irisws/nrl/1/)
- [NRL catalog (text, configuration level)](https://service.iris.edu/irisws/nrl/1/catalog?element=*&format=text&level=configuration)
